    ...
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 ${
          scrolled
            ? 'py-5 md:py-4 bg-[var(--color-bg-glass)] backdrop-blur-xl border-b border-[var(--color-border)] shadow-sm'
            : 'py-6 bg-transparent'
        }`}
      >
      <div className="container flex items-center justify-between relative h-full">
          ...
          <div className="hidden md:flex items-center gap-8 ml-auto mr-8">
            ...
            <button
              ...
              className="p-2 ml-4 rounded-full text-[var(--color-text-primary)] hover:bg-[var(--color-bg-secondary)] transition-colors"
          ...
          <div className="md:hidden absolute right-4 top-1/2 -translate-y-1/2 z-20 flex items-center gap-2">
            <button
              onClick={toggleDarkMode}
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[90] bg-[var(--color-bg-primary)] flex flex-col items-center justify-center"
          >
